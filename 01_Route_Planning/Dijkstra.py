...
if __name__ == "__main__":
    ...
    for place_name in cities:
        ...
        print("Running Dijkstra on ", place_name);
        ...
        while valid_pairs < 10:
            ...
            d_steps = dijkstra(G, start, end, "Manhattan") 

            if d_steps is None:
                continue
            
            iterations_num += d_steps
            valid_pairs += 1

        iter_average = iterations_num/10

        print( "Iterations average ", iter_average)
